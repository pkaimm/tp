...
<div class="navbar-top">
    ...
    <div class="site-brand">
        <a href="index.html"><h1>战神商城</h1></a>
    </div>
    <!-- end site brand	 -->
    ...
    <ul class="slides">
        <li>
            ...
            <div class="caption slider-content  center-align">
                ...
                <a href="" class="btn button-default">爱你</a>
            </div>
        </li>
        <li>
            ...
            <div class="caption slider-content center-align">
                <h2>夹克业务 </h2>
                <h4>Lorem ipsum dolor sit amet.</h4>
                <a href="" class="btn button-default">加油</a>
            </div>
        </li>
        <li>
            ...
            <div class="caption slider-content center-align">
                <h2> 时装店 </h2>
                <h4>Lorem ipsum dolor sit amet.</h4>
                <a href="" class="btn button-default">努力</a>
            </div>
        </li>
    </ul>

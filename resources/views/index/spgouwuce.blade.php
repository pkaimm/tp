        ...
        {{--<div class="cart-menu">--}}
            {{--<div class="container">--}}
                ...
                {{--<div class="total">--}}
                    ...
                    {{--</div>--}}
                {{--</div>--}}
                {{--<button class="btn button-default">结账流程</button>--}}
            {{--</div>--}}
        {{--</div>--}}
    {{--</div>--}}
{{--</div>--}}
...
<div class="cart section">
    <div class="container">
        ...
        <form action="{{url('/index/spgucindex')}}" method="post">
            @csrf
        <div class="content">
            <div class="cart-1">
                @foreach($data as $k=>$v)
        ...
        <a href="{{url('/index/spdingdan')}}?sum={{$sum}}">前往下单</a>
        </form>
    </div>
</div>
<!-- end cart -->
